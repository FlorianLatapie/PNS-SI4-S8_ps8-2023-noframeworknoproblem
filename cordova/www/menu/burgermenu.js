...
<nav class="nav-bar top-corner-content">
    ...
    <a class="nav-link" href="${BASE_URL_PAGE}${PROFILE_URL}">
        <img alt="Profil" src="${profile}"><button>Profil</button>
    </a>
    <a class="nav-link" href="${BASE_URL_PAGE}${NOTIFICATIONS_PAGE_URL}" >
        <img alt="Notifications" src="${notifications}"><button>Notifications</button>
    </a>
    <a class="nav-link" href="${BASE_URL_PAGE}${FRIENDS_URL}">
        <img alt="Amis" src="${friends}"><button>Mes amis</button>
    </a>
    <a class="nav-link" href="${BASE_URL_PAGE}${SEARCH_USERS_URL}" >
    ...
    <a class="nav-link" href="${BASE_URL_PAGE}${RANKING_URL}">
